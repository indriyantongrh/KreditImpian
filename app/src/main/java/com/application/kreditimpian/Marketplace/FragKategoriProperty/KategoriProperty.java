package com.application.kreditimpian.Marketplace.FragKategoriProperty;
...
public class KategoriProperty extends Fragment {

    @BindView(R.id.listProductProperty)
    RecyclerView listProductProperty;
...
//    AdapterProduct adapterProduct;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_kategori_property, container, false);
        ...
        listProductProperty.setItemAnimator(new DefaultItemAnimator());
    ...
    private void getResultList(){
        ...
        mApiService.getResultProperty().enqueue(new Callback<ResponseProductBaru>() {
            @Override
                ...
                if (response.isSuccessful()){
                    ...
                    if (response.body().getStatus()==200) {
                       ...
                       /// progressBar.dismiss();
                        ...
                        listProductProperty.setAdapter(new AdapterProductBaru(mContext, Allproduct));
    ...
    private void initDataIntent(final List<ResultItem> detaiList){
        listProductProperty.addOnItemTouchListener(
