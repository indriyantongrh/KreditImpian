package com.application.kreditimpian.Marketplace.FragKategoriHobi;
...
public class KategoriHobi extends Fragment {

    @BindView(R.id.listProductHobi)
    RecyclerView listProductHobi;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_kategori_hobi, container, false);
        ...
        listProductHobi.setItemAnimator(new DefaultItemAnimator());
    ...
    private void getResultList(){
        ...
        mApiService.getResultHobi().enqueue(new Callback<ResponseProduct>() {
            @Override
            public void onResponse(Call<ResponseProduct> call, Response<ResponseProduct> response) {
                if (response.isSuccessful()){
                    ...
                    if (response.body().getStatus()==200) {
                        ...
                        listProductHobi.setAdapter(new AdapterProduct(mContext, Allproduct));
    ...
    private void initDataIntent(final List<ResultItem> detaiList){
        listProductHobi.addOnItemTouchListener(
