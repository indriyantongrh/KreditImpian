package com.application.kreditimpian.Marketplace.FragKategoriForniture;
...
public class KategoriForniture extends Fragment {

    @BindView(R.id.listProductForniture)
    RecyclerView listProductForniture;
...
//    AdapterProduct adapterProduct;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_kategori_forniture, container, false);
        ...
        listProductForniture.setLayoutManager(mLayoutManager);
        listProductForniture.setItemAnimator(new DefaultItemAnimator());
    ...
    private void getResultList(){
        ...
        mApiService.getResultForniture().enqueue(new Callback<ResponseProductBaru>() {
            @Override
            public void onResponse(Call<ResponseProductBaru> call, Response<ResponseProductBaru> response) {
                if (response.isSuccessful()){
                    ...
                    if (response.body().getStatus()==200) {
                        ...
                        listProductForniture.setAdapter(new AdapterProductBaru(mContext, Allproduct));
    ...
    private void initDataIntent(final List<ResultItem> detaiList){
        listProductForniture.addOnItemTouchListener(
