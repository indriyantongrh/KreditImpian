package com.application.kreditimpian.Marketplace.FragKategorihandphone;
...
public class KategoriHandphone extends Fragment {
    ...
    @BindView(R.id.listProductGadget)
    RecyclerView listProductGadget;
...
//    AdapterProduct adapterProduct;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listProductGadget.setLayoutManager(mLayoutManager);
        listProductGadget.setItemAnimator(new DefaultItemAnimator());
    ...
    private void getResultList(){
        ...
        mApiService.getResultGadget().enqueue(new Callback<ProductResponse>() {
            @Override
            public void onResponse(Call<ProductResponse> call, Response<ProductResponse> response) {
                if (response.isSuccessful()){
                    ...
                    if (response.body().getStatus()==200) {
                        ...
                        listProductGadget.setAdapter(new AdapterProductNew(mContext, Allproduct));
    ...
    private void initDataIntent(final List<ResultItem> detaiList){
        listProductGadget.addOnItemTouchListener(
