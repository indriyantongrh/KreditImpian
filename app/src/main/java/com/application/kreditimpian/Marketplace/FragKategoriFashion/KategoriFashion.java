package com.application.kreditimpian.Marketplace.FragKategoriFashion;
...
public class KategoriFashion extends Fragment {
    ...
    private void getResultList(){
        ...
        mApiService.getResultFashion().enqueue(new Callback<ResponseProduct>() {
            @Override
            public void onResponse(Call<ResponseProduct> call, Response<ResponseProduct> response) {
                if (response.isSuccessful()){
                    ...
                    if (response.body().getStatus()==200) {
                        ...
                        listProductFashion.setAdapter(new AdapterProduct(mContext, Allproduct));
    ...
    private void initDataIntent(final List<ResultItem> detaiList){
        listProductFashion.addOnItemTouchListener(
