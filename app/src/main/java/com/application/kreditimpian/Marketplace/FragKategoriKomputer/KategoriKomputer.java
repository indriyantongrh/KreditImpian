package com.application.kreditimpian.Marketplace.FragKategoriKomputer;
...
public class KategoriKomputer extends Fragment {


    @BindView(R.id.listProductKomputer)
    RecyclerView listProductKomputer;
...
//    AdapterProduct adapterProduct;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView =  inflater.inflate(R.layout.fragment_kategori_komputer, container, false);
        ...
        listProductKomputer.setLayoutManager(mLayoutManager);
        listProductKomputer.setItemAnimator(new DefaultItemAnimator());
    ...
    private void getResultList(){
        ...
        mApiService.getResultKomputer().enqueue(new Callback<ResponseProductBaru>() {
            @Override
            public void onResponse(Call<ResponseProductBaru> call, Response<ResponseProductBaru> response) {
                if (response.isSuccessful()){
                    ...
                    if (response.body().getStatus()==200) {
                        ...
                        listProductKomputer.setAdapter(new AdapterProductBaru(mContext, Allproduct));
    ...
    private void initDataIntent(final List<ResultItem> detaiList){
        listProductKomputer.addOnItemTouchListener(
