...
public class KebijakanPrivacy extends AppCompatActivity implements OnPageChangeListener, OnLoadCompleteListener, OnPageErrorListener {
    ...
    String pdfFileName;
    private static final String TAG = KebijakanPrivacy.class.getSimpleName();
    ...
    private void displayFromAsset(String assetFileName) {
        ...
        pdfViewer.fromAsset(SAMPLE_FILE)
                ...
                .onPageChange(KebijakanPrivacy.this)
                .enableAnnotationRendering(true)
                .onLoad(KebijakanPrivacy.this)
                .scrollHandle(new DefaultScrollHandle(this))
                .spacing(10) // in dp
                .onPageError(KebijakanPrivacy.this)
                .load();
    }
    ...
    public void onBackPressed() {
        startActivity(new Intent(KebijakanPrivacy.this, LoginUser.class));
        finish();
        super.onBackPressed();
    }
}
