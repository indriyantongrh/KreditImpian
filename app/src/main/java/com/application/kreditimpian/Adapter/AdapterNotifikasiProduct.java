 ...
 */
public class AdapterNotifikasiProduct extends RecyclerView.Adapter <AdapterNotifikasiProduct.HolderNotifProduct> {

    List<ResultItem> resultItemList;
    Context mContext;

    public AdapterNotifikasiProduct(Context context, List<ResultItem> dataList){
    ...
    @NonNull
    @Override
    public HolderNotifProduct onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view =LayoutInflater.from(parent.getContext()).inflate(R.layout.list_notifikasi, parent, false);
        return new HolderNotifProduct(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HolderNotifProduct holder, int position) {
    ...
    public class HolderNotifProduct extends RecyclerView.ViewHolder {
        ...
        public HolderNotifProduct(@NonNull View itemView) {
            super(itemView);
