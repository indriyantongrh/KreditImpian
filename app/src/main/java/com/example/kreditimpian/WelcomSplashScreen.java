...
public class WelcomSplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layouts = new int[]{
                R.layout.activity_slide_splash_screen1,
                R.layout.activity_slide_splash_screen2,
                R.layout.activity_slide_splash_screen3,
